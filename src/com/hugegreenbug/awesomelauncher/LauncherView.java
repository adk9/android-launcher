...
public class LauncherView extends CarouselView {

    public LauncherView(Context context, CarouselController controller) {
    ...
    public LauncherView(Context context, AttributeSet attrs, CarouselController controller) {
